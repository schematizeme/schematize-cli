...
"src/selfupdate.rs":         ("hub", "E4 FEITA: a COPIA saiu (495->275 linhas); o que fica e a PONTE (ensure_gestor/run_gestor)"),
"src/upgrade.rs":            ("hub", "E4 FEITA: a recompilacao saiu; `run` delega, e `app_version`/`app_update_available` sao LEITURA"),
"src/versoes.rs":            ("hub", "E4: e LEITURA (qual a ultima versao), nao atualizacao — o badge nao pode exigir o market instalado (piso 10)"),
"src/procedencia.rs":        ("hub", "de qual COMMIT este binario e: plataforma, cada app tem a sua (D4)"),
"src/guipin.rs":             ("hub", "CLASSIFIQUEI ERRADO: o pino e do release DESTE repo, lido pelo release.yml daqui — nao e do market"),
